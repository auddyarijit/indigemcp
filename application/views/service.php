					...
					<div class="col-lg-3 col-md-6">
						<div class="ft-service-innerbox-2 position-relative">
							...
							<div class="ft-service-text position-relative headline">
								...
								<h3><a href="#">Marketing and Coordination</a></h3>
								<div class="ft-btn-2">
									<a href="<?php echo base_url(); ?>Marketing_and_coordination">
					...
					<div class="col-lg-3 col-md-6">	
						<div class="ft-service-innerbox-2 position-relative">
							...
							<div class="ft-service-text position-relative headline">
								...
								<h3><a href="#">Logistics support and Physical Store</a></h3>
								<div class="ft-btn-2">
									<a href="<?php echo base_url(); ?>Logistic_Support">
										<i class="icon-first flaticon-right-arrow"></i>
										<span>Read More</span>
									</a>
								</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="ft-service-innerbox-2 position-relative">
							...
							<div class="ft-service-text position-relative headline">
								...
								<h3><a href="#">Gem Hosting and Services</a></h3>
								<div class="ft-btn-2">
									<a href="<?php echo base_url(); ?>Gem_hosting">
										<i class="icon-first flaticon-right-arrow"></i>
										<span>Read More</span>
									</a>
								</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="ft-service-innerbox-2 position-relative">
							...
							<div class="ft-service-text position-relative headline">
								...
								<h3><a href="#">Cashflow Management</a></h3>
								<div class="ft-btn-2">
									<a href="<?php echo base_url(); ?>Cash_flow_management">
										<i class="icon-first flaticon-right-arrow"></i>
										<span>Read More</span>
									</a>
								</div>
