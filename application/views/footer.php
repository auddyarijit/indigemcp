               ...
               <div class="ft-footer-widget ul-li-block headline pera-content">
                  <div class="logo-widget">
                     ...
                     <div class="footer_social_icon">
                        <a href="#!" class="text-white px-2"><i class="fab fa-facebook-f"></i></a>
                        <a href="#!" class="text-white px-2"><i class="fab fa-twitter"></i></a>
                        <a href="#!" class="text-white px-2"><i class="fab fa-linkedin-in"></i></a>
               ...
               <div class="ft-footer-widget ul-li-block headline pera-content">
                  <div class="menu-widget">
                     ...
                     <ul>
                        ...
                        <li class="text-white"><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+91 87809-82388">  +91 87809-82388</a> 
                        <li class="text-white"><i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+91 85550-22837"> +91 85550-22837</a></li>
                     </ul>
                  </div>
               </div>
            </div>
...
<script src="../maps/api/js-1?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>