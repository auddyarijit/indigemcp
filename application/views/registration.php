                  ...
                  <div class="ft-contact-page-form-wrapper headline">
                     ...
                     <form   action="<?php echo base_url(); ?>Registration/actionregister" id="loginform" name="Login_Form" class="form-signin" method="POST">
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <input type="text" name="firstname" required  placeholder="Enter You First Name">
                           </div>
                           <div class="col-lg-6">
                           ...
                           <div class="col-lg-6">
                              <input type="email" name="email" required placeholder="Enter Your Email" required="true">
                           </div>
